...
<div class="content-wrapper">
    ...
    @include('partials.content-header',['name' => 'Category','key'=>'List','link'=>'category'])
    <!-- /.content-header -->
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="category/create" class="btn btn-outline-success float-right mr-2 mb-3">+ Thêm mới</a>
                </div>
